...
class FFIHashAndDisplayLeaves:
    def __init__(self, lib: CDLL) -> None:
        self.lib = lib
        self.lib.hash_and_display_leaves.argtypes = [
            POINTER(POINTER(c_ubyte)),
            c_size_t,
        ]
        self.lib.hash_and_display_leaves.restype = None

    def hash_and_display_leaves(self, leaves: List[bytes]):
        for leaf in leaves:
        ...
        self.lib.hash_and_display_leaves(leaves_pointers, len_leaves)
